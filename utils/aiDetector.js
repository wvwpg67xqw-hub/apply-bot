...
// Calls the Hugging Face-hosted "Hello-SimpleAI/chatgpt-detector-roberta"
// model — a real online AI-text detector, not a heuristic — and returns
// whether the given text looks human or AI written.
